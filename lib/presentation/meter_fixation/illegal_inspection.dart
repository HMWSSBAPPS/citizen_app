...
class IllegalInspection extends StatefulWidget {
  const IllegalInspection({super.key});

  @override
  State<IllegalInspection> createState() => _IllegalInspectionState();
}

class _IllegalInspectionState extends State<IllegalInspection> {
  ...
  void submitData() async {
    ...
    try {
      ...
      var response = await NetworkApiService()
          .commonApiCall(url: Api.registerIllegalConnection, data: postData);
      EasyLoading.dismiss();
