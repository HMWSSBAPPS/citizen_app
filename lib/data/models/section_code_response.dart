// m_Item1 : {"ResponseCode":"200","ResponseType":"Success","Description":"Section Code is :0431"}
// m_Item2 : "1|0431"

class SectionCodeResponse {
  SectionCodeResponse({
      MItem1? mItem1, 
      String? mItem2,}){
    _mItem1 = mItem1;
  ...
  SectionCodeResponse.fromJson(dynamic json) {
    _mItem1 = json['m_Item1'] != null ? MItem1.fromJson(json['m_Item1']) : null;
    _mItem2 = json['m_Item2'];
  }
  MItem1? _mItem1;
  String? _mItem2;
SectionCodeResponse copyWith({  MItem1? mItem1,
  String? mItem2,
}) => SectionCodeResponse(  mItem1: mItem1 ?? _mItem1,
...
/// Description : "Section Code is :0431"
